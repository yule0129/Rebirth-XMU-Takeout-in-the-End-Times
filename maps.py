...
def build_map():
    ...
    rect(14, 1, 16, 5, "F")    # 足球场
    rect(18, 1, 30, 7, "P")    # 一期操场
    rect(18, 9, 23, 12, "K")   # 篮球场左
    rect(25, 9, 30, 12, "K")   # 篮球场右
    rect(25, 14, 31, 17, "L")  # 芙蓉湖
    rect(14, 9, 16, 11, "B")   # 竞丰餐厅
    rect(14, 15, 17, 16, "B")  # 学生活动中心
    rect(18, 14, 23, 16, "B")
...
MAP_ONE_PATROLS = [
    [(12, 5), (6, 5), (6, 8), (12, 8), (12, 13), (6, 13), (6, 8), (12, 8)],
    [(0, 8), (6, 8), (6, 17), (12, 17), (12, 13), (0, 13)],
    [(13, 0), (18, 0), (18, 8), (13, 8)],
...
def build_map_three():
    ...
    rect(28, 1, 28, 6, "S")
    rect(30, 1, 31, 7, "S")
    rect(13, 14, 16, 16, "K")  # 篮球场
    rect(18, 14, 25, 16, "P")  # 二期操场
